...
# new
bpf.attach_uretprobe(name="pthread", sym="pthread_create", fn_name="probe_create", pid=int(pid))
bpf.attach_uretprobe(name="pthread", sym="pthread_exit", fn_name="probe_exit", pid=int(pid))
